    ...
    <body>
      ...
      <nav class="white" id="nav-navbar">
        <div class="nav-wrapper">
          ...
          <a href="#" class="brand-logo navbar-logo hide-on-small-only">LOGO</a>

          <ul class="right" id="ul-navbar">
            <li><a href="<?php echo site_url('UANGSAKU_Sekolah/profile') ?>"><img class="circle" src="<?php echo base_url('assets/img/user/coba.jpg') ?>"></a></li>
          </ul>
        ...
        <div class="hide-on-small-only col m2 l2" id="side-navbar">
          <ul id="ul-side-navbar">
            ...
            <li id="li-side-navbar">
              <a href="<?php echo site_url('UANGSAKU_Sekolah/Profile') ?>" id="link-side-navbar" class="<?php if ($this->uri->segment(2)=='Profile') {
            ...
            <li id="li-side-navbar2">
              <a href="<?php echo site_url('UANGSAKU_Sekolah') ?>" id="link-side-navbar2" class="<?php if ($this->uri->segment(2)==null) {
                echo"active-side-navbar";
              } ?>">
            ...
            <li id="li-side-navbar3">
              <a href="" id="link-side-navbar3" class="<?php if ($this->uri->segment(2)=='Verifikasi') {
                echo"active-side-navbar";
              } ?>">
                <i class="material-icons">verified_user</i>
                <label id="label-side-navbar3">Verifikasi</label>
              </a>
            </li>

            <li id="li-side-navbar4">
              <a href="<?php echo site_url('UANGSAKU_Sekolah/siswa') ?>" id="link-side-navbar4" class="<?php if ($this->uri->segment(2)=='siswa') {
                echo"active-side-navbar";
              } ?>">
                <i class="material-icons">school</i>
                <label id="label-side-navbar4">SISWA</label>
              </a>
            </li>
