        ...
        <div class="hide-on-small-only col m2 l2" id="side-navbar">
          <ul id="ul-side-navbar">
            ...
            <li id="li-side-navbar">
              <a href="<?php echo site_url('SEKOLAH/Profile') ?>" id="link-side-navbar" class="<?php if ($this->uri->segment(2)=='Profile') {
            ...
            <li id="li-side-navbar2">
              <a href="<?php echo site_url('SEKOLAH') ?>" id="link-side-navbar2" class="<?php if ($this->uri->segment(2)==null) {
                echo"active-side-navbar";
              } ?>">
            ...
            <li id="li-side-navbar4">
              <a href="<?php echo site_url('SEKOLAH/siswa') ?>" id="link-side-navbar4" class="<?php if ($this->uri->segment(2)=='siswa') {
                echo"active-side-navbar";
              } ?>">
