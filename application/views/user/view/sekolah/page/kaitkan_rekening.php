			...
			<div class="col s12 m10 l10 offset-m1 offset-l1" id="BUNGKUS-FORM">
				<div class="card-panel" id="CARD-FORM" style="height: 400px;">
					...
					<div class="input-field col s6">
						<input id="NAMA_BANK" type="text" class="validate" style="margin-bottom: 0!important">
						<label for="NAMA_BANK">NAMA BANK</label>
					</div>
					<div class="input-field col s6">
						<input id="NAMA_REKENING" type="text" class="validate" style="margin-bottom: 0!important">
						<label for="NAMA_REKENING">NAMA REKENING</label>
					</div>
					<div class="input-field col s6">
						<input id="NO_REKENING" type="number" class="validate" style="margin-bottom: 0!important">
						<label for="NO_REKENING">NO REKENING</label>
					</div>
					<div class="input-field col s6">
						<input id="CABANG" type="text" class="validate" style="margin-bottom: 0!important">
	...
	$("#BTN-SIMPAN-REKENING").click(function () {
		...
		if (nama_bank == '' || nama_rekening == '' || no_rekening == '' || cabang == '') {
			...
			if (no_rekening.length > 16) {
				...
				$.ajax({
					url : '<?php echo site_url('UANGSAKU_sekolah/proses_tambah_data_rekening') ?>',
					type : 'post',
					...
					success : function(response){
						if (response == 1) {
							...
							$("#BTN-SIMPAN-PEMBIAYAAN").show();
							$("#BTN-DISABLE").css('display','none');
							$("#flash-tambah").text('gagal mengaitkan rekening');
							$("#flash-tambah").attr('class','red-text');
						}
					}
				});
