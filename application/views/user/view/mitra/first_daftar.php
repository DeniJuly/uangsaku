		...
		<div class="col s10 m4 l4 offset-s1 offset-m4 offset-l4">
			...
			<div id="FORM-DAFTAR-SEKOLAH">
				<div class="input-field col s12">
		          <input placeholder="Nama" id="NAMA" type="text" class="validate" autocomplete="off" autofocus="on">
		        </div>
		        <div class="input-field col s12">
		          <input placeholder="Email" id="EMAIL_MITRA" type="email" class="validate" autocomplete="off" autofocus="on">
		        </div>
		        <div class="input-field col s12">
		          <input placeholder="Password" id="PASSWORD_MITRA" type="password" class="validate">
		        </div>
		        <div class="input-field col s12">
