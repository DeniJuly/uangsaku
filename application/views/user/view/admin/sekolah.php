            ...
            <div class="fluid-container">
              <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                ...
                <div class="ticket-details col-md-9">
                  ...
                  <p class="text-gray ellipsis mb-2">
                  Alamat : Pucang, Bawang, Banjarnegara, Jawa Tengah.
                  </p>
                ...
                <div class="ticket-actions col-md-2">
                  <div class="btn-group dropdown">
                    ...
                    <div class="dropdown-menu">
                      ...
                      <a class="dropdown-item bg-primary text-white" href="#" onclick="confirm('Menonaktifkan Akun akan membuat user terkait tidak dapat melakukakan apapun !');">
