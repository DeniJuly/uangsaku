<div class="main-panel">
  <div class="content-wrapper"> 
    ...
    <div class="row center">
      ...
      <button type="button" class="btn btn-primary btn-lg btn-rounded" data-toggle="modal" data-target="#exampleModal" style="margin-bottom: 20px;"><i class="mdi mdi-library-plus"></i>Tambah Sekolah</button>
      <h1 class="display-3 text-primary">Daftar Data Sekolah</h1>
        <div class="row">
    ...
    success : function(data){
      ...
      for (var i = 0; i < data.length; i++) {
          hasil +="<div class='card'>"+
                  ...
                  "<p class='text-gray ellipsis mb-2'>NPSN : "+data[i].NPSN+"</p>"+
                  "<p class='text-gray ellipsis mb-2'>Alamat :"+data[i].ALAMAT+"</p>"+
                  "<p class='text-gray ellipsis mb-2'>Tingkat sekolah :"+data[i].TINGKAT_SEKOLAH+"</p>"+
                  ...
                  "<a class='dropdown-item text-warning' onclick='nonaktifkan_sekolah("+data[i].ID_USER+")'>"+
                    "<i class='mdi mdi-speaker-off fa-fw'></i>Nonaktifkan Akun</a>"+
                  "<a class='dropdown-item text-primary' onclick='aktifkan_sekolah("+data[i].ID_USER+")'>"+
